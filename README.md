![Dashboard Overview](Dashboard%20Overview.gif)
*End-to-End Power BI dashboard walkthrough*
...
This repository contains an **end-to-end Online Examination System**.  
The system covers **everything from database design, ETL (SSIS), SQL Server procedures, to SSRS reports and Power BI dashboards**.
...
- **Stored Procedures** for CRUD operations, Exam management, and SSRS reports  
- **ETL with SSIS** for Data Warehousing  
- **SSRS Reports** for operational insights  
- **Interactive Power BI Dashboards** for analytical insights  
- Complete **Data Pipeline from Source to Insights**  
- **End-to-End Project** connecting Database, ETL, Reporting, and Visualization layers  

---

⭐ *This project demonstrates a complete data lifecycle — from database modeling and ETL to reporting and business intelligence visualization.*
